...
r1<-data.frame(YEAR=s1$YEAR,result=s1$TOTAL/car$TOTAL*100000) #서울
r2<-data.frame(YEAR=s2$YEAR,result=s2$TOTAL/car2$TOTAL*100000)#경기도
r3<-data.frame(YEAR=s3$YEAR,result=s3$TOTAL/car3$TOTAL*100000)#인천
